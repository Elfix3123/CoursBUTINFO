...
See [Explicit Success and Failure](assertions.md#success-failure) in
the Assertions Reference.

### Exception Assertions

See [Exception Assertions](assertions.md#exceptions) in the Assertions
Reference.
...
[`EXPECT_PRED*`](assertions.md#EXPECT_PRED) in the Assertions
...
[`EXPECT_PRED*`](assertions.md#EXPECT_PRED) and
[`EXPECT_TRUE`](assertions.md#EXPECT_TRUE) unsatisfactory, or some
...
[`EXPECT_PRED_FORMAT*`](assertions.md#EXPECT_PRED_FORMAT) in the
Assertions Reference for details.

### Floating-Point Comparison

See [Floating-Point Comparison](assertions.md#floating-point) in the
...
[`EXPECT_PRED_FORMAT2`](assertions.md#EXPECT_PRED_FORMAT), for
example:
...
You can use the gMock [string matchers](matchers.md#string-matchers)
with [`EXPECT_THAT`](assertions.md#EXPECT_THAT) to do more string
...
See [Windows HRESULT Assertions](assertions.md#HRESULT) in the
Assertions Reference.
...
[Death Assertions](assertions.md#death) in the Assertions Reference
for details.
...
See [Death Assertions](assertions.md#death) in the Assertions
Reference.
...
[`INSTANTIATE_TEST_SUITE_P`](testing.md#INSTANTIATE_TEST_SUITE_P) in
...
[`Values`](testing.md#param-generators) parameter generator:
...
[parameter generator](testing.md#param-generators).
...
[`ValuesIn`](testing.md#param-generators) parameter generator:
...
[`TestInfo`](testing.md#TestInfo) class has this information.

To obtain a `TestInfo` object for the currently running test, call
`current_test_info()` on the [`UnitTest`](testing.md#UnitTest)
singleton object:
...
[`testing::TestEventListener`](testing.md#TestEventListener) or
[`testing::EmptyTestEventListener`](testing.md#EmptyTestEventListener)
...
[`TestEventListeners`](testing.md#TestEventListeners) - note the "s"
