public class ListeTrieeD<TypeInfo extends Comparable<TypeInfo>> implements ListeTrieeInterface<TypeInfo> {
    ...
    public ListeTrieeC<TypeInfo> renverseListe(){
		ListeTrieeC<TypeInfo> lisC = new ListeTrieeC<>();
		Cellule<TypeInfo> celluleActive = this.getTete();

		while (celluleActive != null) {
			lisC.insereTrie(celluleActive.getInfo());
